...
Furthermore, to each group (intervention and control) has been administered a questionnaire regarding several psychological dimensions, respectively:
...
•	**Intention to leave the native country (ItL)**: The ItL scale  was developed *ad hoc*, based on various previous questionnaires concerning turnover intentions <!--ref-->, in order to assess the intention to leave Italy by the sudents and look for a job in a foreign country. We presumed that this orientation would been lower for the intervention group rather than the control group students, as the first one acquire more tools to find and maintain a job than the second one. Moreover, we think this result could be directly originated by the level of self-efficacy and sense of coherence.
